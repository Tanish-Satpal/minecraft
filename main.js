...
function new_image(get_image){
    ...
    console.log("canvas.add(block_image_object);")
    });
}
...
function my_keydown(e){
    ...
    if(keypressed=='77'){
        new_image('My_wall.jpg');
        console.log("m");
    }
    if(keypressed=='78'){
        new_image('nether.jpg');
        console.log("n");
    }
    if(keypressed=='79'){
        new_image('Ore of Diamond.jpg');
        console.log("o");
    }
    if(keypressed=='82'){
        new_image('roof.jpg');
